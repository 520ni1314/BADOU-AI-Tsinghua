...
class LinearLeastSquareModel:
    ...
    def __init__(self, input_columns, output_columns, debug=False):
        self.input_columns = input_columns   #range(0,1)
...
def test():
    ...
    print(n_inputs)
    input_columns = range(n_inputs)  # 数组的第一列x:0    #range(n_inputs)创建0->n_inputs的列表
